...
- PM-stage SRS persistence failure is a recurring pattern (issues #147–#183). Always check if SRS file is in diff immediately. This pattern extends to engine scope (requirements-engine.md) too. 24 consecutive failures; resolved in iter 2 for each issue.
