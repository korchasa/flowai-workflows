...
- Double-v version string bug pattern: when CI passes `github.ref_name` (e.g., "v1.2.3") as VERSION env and getVersionString() prepends "v", the result is "flowai-pipelines vv1.2.3". Check for leading-v stripping in compile scripts.
